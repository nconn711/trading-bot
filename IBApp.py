...
class IBClient(EWrapper, EClient):
    def __init__(self, host='127.0.0.1', port=7497, client_id=1): # 4002 for IB Gateway
        ...
        self.exchange = 'SMART'
        self.currency = 'USD'
        self.lower_bound = 251.5  # Trigger price for SELL orders
        self.upper_bound = 252.0  # Trigger price for BUY orders
        self.buy_qty = 100        # Shares per order
